...
import { BarChart3, Users, ShoppingBag, Zap, Store, LogOut, BookOpen, Home, Camera, Package } from 'lucide-react';
...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  const menuItems = {
    admin: [
      ...
      { id: 'mall-admin', label: '商城管理', icon: Package },
      { id: 'training', label: '培训教育', icon: BookOpen },
      { id: 'ai', label: 'AI', icon: Zap },
      { id: 'health-assistant', label: '健康助手', icon: Camera }
    ],
    staff: [
